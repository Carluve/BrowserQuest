/* Ported from server/js/format.js (uses global `log`). */
...
globalThis.FormatChecker = FormatChecker;

var checker = new FormatChecker();

module.exports = { FormatChecker: FormatChecker, check: checker.check.bind(checker) };
