/*
 * Server copy of shared/js/gametypes.js, adapted for strict-mode bundling:
 *  - `Types` is declared with `var` (no implicit global write)
 *  - underscore is required explicitly instead of relying on a leaked global
 */
