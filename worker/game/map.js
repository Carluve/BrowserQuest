/* Ported from server/js/map.js.
 * Node fs/path removed: the constructor now takes the already-parsed map JSON
 * (the Worker imports server/maps/world_server.json directly). `ready()` fires
 * synchronously since the map is loaded during construction.
 */
