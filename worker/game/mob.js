/* Ported from server/js/mob.js.
 * `MobArea` and `ChestArea` are referenced as globals (registered by their
 * modules) and only used at call-time (respawn), by which point they exist.
 */
